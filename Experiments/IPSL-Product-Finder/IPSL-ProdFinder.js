  ...
  exp.init = function() {
    ...
    var inter = setInterval(function() {
      if (('.section-bannertop.header_bottom img').length) {
        ...
        product_selector += '<label>My project is for:</label><br>';
        ...
        product_selector += "<label>I'm interested in:</label><br>";
        ...
        product_selector += '<option value="https://www.ipsluk.co.uk/bathroom-flooring.html">Flooring</option>';
        ...
        product_selector += '<input name="product_finish" type="radio" value="https://www.ipsluk.co.uk/bathroom-wall-panels/proclad-solid-colour-cladding.html" >Plain colours </input>';
        product_selector += '<input name="product_finish" type="radio" value="https://www.ipsluk.co.uk/bathroom-wall-panels/dumawall-tile-wall-panels.html">Tiles</input>';
        ...
        product_selector += '<input  name="preferred_installation" class="installation_joint" type="radio" value="https://www.ipsluk.co.uk/bathroom-wall-panels/aquabord-laminate-panels-1200mm-width.html">Separate joint trim</input>';
        product_selector += '</div>';
        ...
        product_selector += '<input name="preferred_panels" class="panels_narrow" type="radio" value="https://www.ipsluk.co.uk/bathroom-wall-panels/aquaclad-pvc-narrow-wall-panels-10.html">Narrow (250 mm)</input>';
        product_selector += '</div>';
        product_selector += '</form>';
        if (window.location.href.indexOf('https://www.ipsluk.co.uk/hygienic-wall-cladding.html') > -1) {
          $('.bar_topP').after(product_selector);
          $('.new_form').css({'max-width': '1260px', 'margin': '0 auto'});
        }
        else {
