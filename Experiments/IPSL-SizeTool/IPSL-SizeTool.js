...
var addToBasket = function addToBasket(order) {
  ...
  // ADD items
	...
	jQuery.ajax({
		type: 'POST',
		url: 'https://www.ipsluk.co.uk/checkout/cart/add/',
		data: formData,
		success: function() {
...
function addCopy() {
	var copy1 = '<p class="card__description">Cladseal provides a stronger watertight seal than traditional silicone. More information can be found <a href="https://www.ipsluk.co.uk/watertight-trim-cladseal.html">here</a>.</p>';
